        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Dziedzina = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CzasUkonczenia = table.Column<TimeSpan>(type: "time", nullable: false),
                    OdpowiedziJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CzasyOdpowiedziJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Wynik_AspNetUsers_UzytkownikId",
                        column: x => x.UzytkownikId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Wynik_Quiz_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quiz",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pytanie_QuizId",
                table: "Pytanie",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_Wynik_QuizId",
                table: "Wynik",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_Wynik_UzytkownikId",
                table: "Wynik",
                column: "UzytkownikId");
        }
